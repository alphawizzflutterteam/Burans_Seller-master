...
//                        Parameter For API Call
  ...
  String? deliverableDateValue = "0"; //deliverable_date
  String? deliverableZipcodes; //deliverable_zipcodes
  String? deliverableZipcodes2; //deliverable_zipcodes
...
//logic clear
        ...
        children: [
          Padding(
            ...
            child: Container(
              width: width * 0.4,
              child: Text(
                getTranslated(context, "Delivery Time")! + " :",
                style: TextStyle(
                  fontSize: 16,
                  color: black,
                ),
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Center(
                          child: Text(
                        '${fromTime.hourOfPeriod}:${fromTime.minute} ${fromTime.period.name}',
                        style: TextStyle(
                          color: fontColor,
                          fontWeight: FontWeight.normal,
                        ),
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Center(
                          child: Text(
                        '${toTime.hourOfPeriod}:${toTime.minute} ${toTime.period.name}',
                        style: TextStyle(
                          color: fontColor,
                          fontWeight: FontWeight.normal,
                        ),
  ...
  TimeOfDay toTime = TimeOfDay(hour: 0, minute: 0);
  void _selectTime({required bool isFromTime}) async {
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          getTranslated(context, "Select Delivery Type")!,
                          style: Theme.of(this.context)
                              .textTheme
                              .subtitle1!
                              .copyWith(color: fontColor),
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      getTranslated(context, "Same Day")!,
                                    ),
                                  ],
                                ),
                              ),
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      getTranslated(context, "Next Day")!,
                                    ),
                                  ],
                                ),
                              ),
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      getTranslated(context, "Minimum 3 Days")!,
                                    ),
                                  ],
                                ),
                              ),
                                        ...
                                        setState(
                                          () {
                                            if (deliverableZipcodes == null) {
                                              deliverableZipcodes =
                                                  zipSearchList[index].id;
                                              deliverableZipcodes2 =
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Text(
              getTranslated(context, "Delivery Type")! + " :",
              style: TextStyle(
                fontSize: 16,
              ),
            ),
  ...
  Future<void> addProductAPI(List<String> attributesValuesIds) async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        request.fields[ShortDescription] = sortDescription?? 'description';
        ...
        request.fields[TotalAllowedQuantity] = totalAllowQuantity ?? '1';
        request.fields[MinimumOrderQuantity] = minOrderQuantity ?? '1';
        request.fields[QuantityStepSize] = quantityStepSize ?? '1';
        ...
        request.fields[DeliveryDay] = deliverableDateValue == '0'
            ? 'sameday'
            : deliverableDateValue == '1'
                ? 'nextday'
                : 'minimum 3 days';
        request.fields[FromTime] =
            '${fromTime.hourOfPeriod}:${fromTime.minute} ${fromTime.period.name}';
        request.fields[ToTime] =
            '${toTime.hourOfPeriod}:${toTime.minute} ${toTime.period.name}';
        ...
        if (productType == 'simple_product') {
         ...
         print(" add product parameterrrs : ${request.fields}");
